...
public class CategoryServiceImpl implements CategoryService {
    ...
    @Override
    public List<Category> findByCategory1ParentId(Integer parentId) {
    ...
    @Override
    public List<Category> findCategory2ByParentId(Integer parentId) {
        Category category = new Category();
        category.setParentId(parentId);
        List<Category> select = categoryMapper.select(category);
        return select;
    ...
    @Override
    public List<Category> findCategory3ByParentId(Integer parentId) {
        Category category = new Category();
        category.setParentId(parentId);
        List<Category> select = categoryMapper.select(category);
        return select;

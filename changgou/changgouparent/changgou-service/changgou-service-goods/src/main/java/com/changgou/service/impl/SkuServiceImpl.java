...
@Autowired(required = false)
    ...
    @Override
    public void updateSkuWeightByIdForSku(Sku sku) {
        skuMapper.updateByPrimaryKeySelective(sku);
    }

    @Override
    public void updateSkuWeightById(Integer weight,long SkuId) {
        Sku sku = new Sku();
        sku.setId(SkuId);
    skuMapper.updateSkuWeightById(weight,SkuId);

    }

    @Override
    public List<Sku> listSku(long spuID) {
        return skuMapper.listSku(spuID);
    }

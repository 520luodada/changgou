...
public class ParaController {
    ...
    @PostMapping(value = "/findlistpare/{categoryid}" )
    public Result<List<Para>> findlistpare(@PathVariable( value ="categoryid")Integer categoryid){
        //调用SpecService实现分页条件查询Spec
        List<Para> paraList = (List<Para>) brandService.all(categoryid).get("paraList");

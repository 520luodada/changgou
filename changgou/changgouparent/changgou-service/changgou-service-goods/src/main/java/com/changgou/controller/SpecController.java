...
public class SpecController {
    ...
    @PostMapping(value = "/findlistspec/{categoryid}" )
    public Result<List<Spec>> listspec(@PathVariable( value ="categoryid")Integer categoryid){
        //调用SpecService实现分页条件查询Spec
        List<Spec> specList = (List<Spec>) brandService.all(categoryid).get("specList");

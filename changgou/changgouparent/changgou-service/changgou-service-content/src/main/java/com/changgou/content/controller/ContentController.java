...
public class ContentController {
    ...
    public Result<List<Content>> selectByCategoryId(@PathVariable(value = "categoryId")long categoryId){
        List<Content> contents = contentService.listContent(categoryId);
